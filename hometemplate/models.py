...
class SubMenuConfig(TimeStampedModel,models.Model):
	Caption = models.CharField(max_length=100)
	menuaction = models.CharField(max_length=50,choices=SUBMENU_CHOICES)
	pageValue = models.ForeignKey(Menu,on_delete=models.SET_NULL ,related_name='submenu_url_params',null=True, blank=True)
	expression = models.CharField(max_length=200,null=True, blank=True)
	homepageid = models.ForeignKey(Homepage,on_delete=models.CASCADE ,related_name='submenu3_url_params')
	displayorder = models.BigIntegerField()
	project = models.ForeignKey(Project,on_delete=models.CASCADE ,related_name='submenu2_url_params')
